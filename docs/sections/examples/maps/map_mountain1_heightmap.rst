...
Overview
========
Loads the bundled mountain1 heightmap assets and drops an Aliengo robot on it with PD control. It sets the RaisimServer map name to ``mountain1`` so ``rayrai_tcp_viewer`` matches the terrain.
